...
const OutfitCard = memo(({ product }) => {
  ...
  return (
    <div className="productCard border border-gray-300 p-4 bg-base-100 w-60 h-80 items-center">
      ...
      <h3 className="font-bold text-center text-base-content overflow-hidden whitespace-nowrap overflow-ellipsis">{product.name}</h3>
      {product.salePrice ? (
