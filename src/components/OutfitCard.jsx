  ...
  return (
    <div className="productCard border border-gray-300 p-4 bg-white w-60 h-80 items-center">
      <div className="imageContainer relative w-48 h-48 overflow-hidden rounded-lg mx-auto">
        <img src={product.photo} alt={product.name} className="w-full h-full object-cover rounded-lg p-1" />
        <button type="button" className="absolute top-2 right-2 z-10" aria-label="remove" onClick={handleRemove}><CiCircleRemove /></button>
      </div>
