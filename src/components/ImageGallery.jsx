      ...
      {loading
        ...
        : (
          <div className="w-full h-full relative">
            ...
            {selectedImage > 0 ? <ImageGalleryButton testid="image-left" styles="text-base-content left-4" cb={() => switchImage(-1)}><FaArrowLeft /></ImageGalleryButton> : null}
            {selectedImage < photos.length - 1 ? <ImageGalleryButton testid="image-right" styles="right-4" cb={() => switchImage(1)}><FaArrowRight /></ImageGalleryButton> : null}
          </div>
