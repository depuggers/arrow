...
function RelatedProduct({ defaultProduct, defaultProductUrl, defaultProductRating }) {
  ...
  return (
    ...
    <div className="relative">
      <div className="border border-gray-300 p-4 bg-base-100 w-60 h-80 " onClick={handleClick}>
        ...
        <h3 className="font-bold text-center text-base-content overflow-hidden whitespace-nowrap overflow-ellipsis">{defaultProduct?.name}</h3>
